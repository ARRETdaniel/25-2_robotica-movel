"""
Potential Fields Planner for TP2
=================================

This module implements the Potential Fields navigation algorithm for differential
drive robots. The algorithm creates attractive forces towards the goal and
repulsive forces from obstacles to generate a collision-free path.
...
References:
- Aula 12 - Planejamento de Caminhos - Campos Potenciais
- aula12-planejamento-caminhos-campos-potenciais.ipynb
- 2a_campos_potenciais_youbot.ipynb
