"""
Roadmap Path Planning Algorithm for Holonomic Robots
=====================================================

This module implements a Probabilistic Roadmap (PRM) path planning algorithm
suitable for holonomic robots. The algorithm builds a graph by randomly sampling
collision-free configurations and connecting them to nearby neighbors, then uses
A* to find the shortest path.

Theory Reference:
- Aula 13: Planejamento de Caminhos - Roadmaps
- Roadmap methods create a graph representation of the free space
- For holonomic robots, we can plan paths without kinematic constraints
