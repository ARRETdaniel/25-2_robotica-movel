...
function sysCall_sensing()
    ...
    -- CRITICAL FIX: Use buffer properties instead of deprecated string signals
    -- String signals cause UTF-8 encoding errors with binary data in ZMQ Remote API
    -- Reference: https://manual.coppeliarobotics.com/en/properties.htm (Signals section)
    -- Reference: https://manual.coppeliarobotics.com/en/regularApi/simSetBufferProperty.htm
    if #dists>0 then
